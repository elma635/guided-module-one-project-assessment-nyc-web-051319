...
t6 = Ticket.create(customer_id: c1.id, broadway_show_id: b5.id, seat_number:60, date:"09/10/2019")

#all tix for Jess
t2 = Ticket.create(customer_id: c2.id, broadway_show_id: b2.id, seat_number:30, date: "06/01/2019")
t7 = Ticket.create(customer_id: c2.id, broadway_show_id: b3.id, seat_number:30, date: "06/01/2019")
t8 = Ticket.create(customer_id: c2.id, broadway_show_id: b4.id, seat_number:30, date: "06/01/2019")

#all tix for Lamia
t3 = Ticket.create(customer_id: c3.id, broadway_show_id: b3.id, seat_number:40, date: "04/03/2019")
t9 = Ticket.create(customer_id: c3.id, broadway_show_id: b5.id, seat_number:40, date: "04/03/2019")
